 ...
 */
@Data
public class PageInfoJsTemplateContext extends BasicTemplateContext {


    public PageInfoJsTemplateContext(TableModel table, String tablePrefix, ApplicationConfig applicationConfig) {

        super(table, tablePrefix, applicationConfig);

        PackageConfig packageConfig = applicationConfig.getPackageConfig();
        this.setFileName(super.getBizEnName() + "_info.js");
